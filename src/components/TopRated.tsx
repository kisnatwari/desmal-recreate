    ...
    return (
        <div>
            <div className='container py-4'>
                ...
                <div className='bg-gradient-to-bl from-white to-secondary dark:from-secondary dark:to-slate-950'>
                    <Swiper
                        slidesPerView={2}
                        spaceBetween={0}
                        navigation={true}
                    ...
                    >
                        {
                            Array.from({ length: 10 }, (_, i) => i + 1).map((i) => {
                                return (
                                    <SwiperSlide key={i}>
                                        <div className='w-full h-72 p-2 flex flex-col bg-transparent border'>
                                            <div className='flex justify-between items-center'>
                                                <span className='text-[10px] text-secondary-foreground/75'>CATEGORY 1</span>
                                                <Heart className='w-4' />
                                            </div>
